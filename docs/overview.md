...
- 图标美化：可对应用列表/桌面列表分别启用，支持多种主题风格。  
- 高级：可切换图标提取方式，用于修复旧式透明图标（不建议修改）。  
...
- 性能与内存排查：`docs/performance/memory.md`。
- 调试日志（Windows）：`docs/debug/logging.md`。
